...
@Composable
fun <O, E : AppFailure> rememberTextFieldValidated(
    initial: String? = null,
    readOnly: Boolean = false,
    validator: Validator<String, O, E>,
): TextFieldValidatedState<O, E> {
    ...
    return TextFieldValidatedState(
        value = textField,
        readOnly = readOnly,
        error = error,
        validate = {
...
@Immutable
data class TextFieldValidatedState<O, out E : AppFailure>(
