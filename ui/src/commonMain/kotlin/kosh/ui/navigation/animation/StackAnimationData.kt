...
import kosh.ui.navigation.animation.transitions.predictiveSharedAxisXIn
import kosh.ui.navigation.animation.transitions.predictiveSharedAxisXOut
...
data class StackAnimationData(
    ...
    val predictiveEnter: EnterTransition? = null,
    val predictiveExit: ExitTransition? = null,
)
...
fun Density.sharedAxisX(
    ...
    predictiveEnter = predictiveSharedAxisXIn(slide),
    predictiveExit = predictiveSharedAxisXOut(slide),
)
