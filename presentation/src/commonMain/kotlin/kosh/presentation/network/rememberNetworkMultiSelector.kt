...
fun rememberNetworkMultiSelector(
    ...
    val required: Set<NetworkEntity.Id> by remember {
        mutableStateOf(initialRequired)
    }
    var selected: Set<NetworkEntity.Id> by rememberSerializable {
        mutableStateOf(initialSelected + initialRequired)
    }
